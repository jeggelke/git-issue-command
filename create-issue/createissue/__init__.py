...
import argparse, requests, json, getpass
    ...
    if not user_username or not repo_weburl or not issue_title or not issue_comment:
        ...
        if url_ok == True:
            ...
            if rpost.status_code == 404:
                print 'URL not found, please check and try again. Ensure that there is a trailing slash'
        else:
            print 'Repository not found. Please ensure that your url is correct and try again. Ensure that there is a trailing slash'
